    ...
    static class Program
    {
      ...
      [LoaderOptimization(LoaderOptimization.MultiDomain)]
        static void Main()
        {
            ...
            /*создаём необходимые домены приложений с дружественными именами 
             * и сохраняем ссылки на них в соответствующие переменные*/
            ...
            *данных из загруженных сборок*/
            ...
            CreateInstance(DrawerAsm.GetType("TextDrawer. Form1")) as Form;
